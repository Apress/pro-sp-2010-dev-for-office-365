...
namespace Chapter11.SharePoint.Features.Silverlight
{
    /// <summary>
    ...
    public class Chapter11EventReceiver : SPFeatureReceiver
    {
        public override void FeatureActivated(SPFeatureReceiverProperties properties)
        {
            ...
            if (site != null)
            {
                ...
                string xapFileUrl = SPUrlUtility.CombineUrl(mpGallery.RootFolder.Url, "Chapter11.Silverlight.xap");
